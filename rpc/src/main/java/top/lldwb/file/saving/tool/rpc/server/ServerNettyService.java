...
import top.lldwb.file.saving.tool.rpc.message.SocketMessageDecoder;
import top.lldwb.file.saving.tool.rpc.message.SocketMessageEncoder;
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class).childHandler(new ChannelInitializer<SocketChannel>() {
                ...
                public void initChannel(SocketChannel ch) {
                    ...
                    channel.addLast(new SocketMessageEncoder(), new SocketMessageDecoder(), new ServerHandler(connection));
                }
